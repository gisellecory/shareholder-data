# Outdated: Changed approach, using binary indicators (e.g. downloaded, metadata) rather than burndown lists

# Reads in company number list, merges with combined metadata output, keeps rows that do not have metadata, and saves these to a 'metadata input' CSV to use in the API

# # # # # #
#  Refresh burndown list of company number for main API (to gether metadata)
# # # # # #
