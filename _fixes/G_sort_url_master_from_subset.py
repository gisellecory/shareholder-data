# python3 sort_url_master_from_subset.py
...
# print(all_meta.groupby("subset").count())
# print(all_meta.groupby("metadata").count())
# print(all_meta.groupby("downloaded").count())
# print(all_meta.isnull().sum())
...
# in_meta_not_ch = all_meta[all_meta['_merge'] == "left_only"]
# print(in_meta_not_ch.head())
# all_meta = all_meta.set_index('co_numb').join(co_numbs.set_index('co_numb'),how="left", lsuffix="_meta", rsuffix="_master_numbs", sort=True)
# all_meta = all_meta[all_meta.metadata.isnull()]
# print(all_meta[(all_meta['subset'] == "NA")].count())
# & (all_meta['subset'] != 1)
# print(all_meta.head())
# print(list(all_meta))
# print(len(all_meta))
# all_meta = all_meta.join(co_numbs,on="co_numb", how="outer", lsuffix="_meta", rsuffix="_master_numbs", sort=True)
